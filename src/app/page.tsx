    ...
    return (
        <>
            <div className="wrapperContent">
                ...
                <p>
                    Bienvenido a la galería de fotos de Marta y Roberto. Un
                    album donde ver el bonito amor que compartimos.
                    <br />
                    <br />
                    Desde el 8 de noviembre de 2024, hemos compartido momentos
                    inolvidables juntos.
                </p>
            </div>
